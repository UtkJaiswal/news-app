...
export default class App extends Component {
  ...
  render() {
    return (
      ...
      />
      <Switch>
          <Route exact path="/"><News setProgress={this.setProgress}  key="/" pageSize={9} country="in" category="general"/></Route>
          ...
          <Route exact path="/general"><News setProgress={this.setProgress}  key="/" pageSize={9} country="in" category="general"/></Route>
